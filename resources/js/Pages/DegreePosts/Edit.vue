...
<!--                                    &lt;!&ndash;                                    <inertia-link preserve-scroll&ndash;&gt;-->
<!--                                    &lt;!&ndash;                                                  v-if="post.user.id === $page.props.auth.user.id"&ndash;&gt;-->
<!--                                    &lt;!&ndash;                                                  class=" -mt-6  "&ndash;&gt;-->
<!--                                    &lt;!&ndash;                                                  as="button"&ndash;&gt;-->
<!--                                    &lt;!&ndash;                                                  :href="route('posts.edit', post.id)"&ndash;&gt;-->
<!--                                    &lt;!&ndash;                                    >&ndash;&gt;-->
<!--                                    &lt;!&ndash;                                        ...&ndash;&gt;-->
