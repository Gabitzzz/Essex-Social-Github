...
<!--&lt;!&ndash;                        <img :src="avatar" class="rounded-full avatar w-12 h-12" alt="avatar">&ndash;&gt;-->
...
<!--                    <div class="flex mt-5">-->
<!--&lt;!&ndash;                        <img :src="avatar" class="rounded-full avatar w-10 h-10 mx-1" alt="avatar">&ndash;&gt;-->
...
<!--                        &lt;!&ndash;                    <textarea name="post" rows="3" class="border rounded px-2 py-2 w-full"&ndash;&gt;-->
<!--                        &lt;!&ndash;                              :placeholder="`Post something  ...`" v-model="form.body"></textarea>&ndash;&gt;-->
